...
export function ChartExportPreview({
	...
	const domain = isWhitelabel ? branding.parentUrl?.replace(/^https?:\/\//, "").replace(/\/$/, "") || "" : "github.com/cangqiaoGEO";
			...
			<div className="flex-1 flex items-center justify-between px-10 min-h-0">
				<div className="flex items-center gap-3">
					...
					{isWhitelabel ? (
						...
						<span className="font-bold tracking-tight text-[#0E6B5B]" style={{ fontSize: 20 }}>
							OpenGEO
						</span>
					)}
				</div>
