...
export const ENV_REGISTRY: EnvVarSpec[] = [
	...
	},
	{
		...
		requiredBy: "dynamic-scrape-targets",
		provider: "volcengine",
		description: "Volcengine Ark API key for Doubao.",
	},
	{
		...
		requiredBy: "dynamic-scrape-targets",
		provider: "dashscope",
		description: "Alibaba DashScope API key for Qwen.",
	},
	{
		...
		description: "DeepSeek official API key.",
	},
	{
		name: "TENCENT_TOKENHUB_API_KEY",
		scope: "server",
		requiredBy: "dynamic-scrape-targets",
		provider: "tencent-tokenhub",
		description: "Tencent TokenHub API key for Yuanbao (Hunyuan).",
	},
	{
		name: "JINA_API_KEY",
		scope: "server",
